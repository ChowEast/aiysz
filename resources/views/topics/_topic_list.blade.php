            ...
            <li class="media">
                <div class="media-left">
                    <a href="{{ route('users.show', [$topic->user_id]) }}">
                        ...
                        <img class="media-object img-thumbnail" style="width: 42px; height: 42px;border-radius:50%;background-color:#FFFFFF;" src="{{ $topic->user->avatar }}" title="{{ $topic->user->name }}">
                    </a>
                </div>
